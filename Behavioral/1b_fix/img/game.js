...
jsPsych.plugins["dez-1b-fix"] = (function() {
		...
		plugin.trial = function(display_element, trial) {
			...
			trial.trialnum = parseInt(jsPsych.currentTimelineNodeID().split("-")[2].split(".")[0]);
			...
			var end_trial = function() {
				...
				var curData = jsPsych.data.getLastTrialData();
